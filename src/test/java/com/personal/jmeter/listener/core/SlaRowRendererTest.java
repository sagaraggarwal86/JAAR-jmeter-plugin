...
class SlaRowRendererTest {
    ...
    /**
     * Column indices matching {@link ColumnIndex} constants.
     */
    private static final int NAME_COL = ColumnIndex.NAME_COL_INDEX;       // 0
    private static final int AVG_COL = ColumnIndex.AVG_COL_INDEX;        // 4
    private static final int PNN_COL = ColumnIndex.PERCENTILE_COL_INDEX; // 7
    private static final int ERROR_RATE_COL = ColumnIndex.ERROR_RATE_COL_INDEX; // 9
    ...
    @BeforeEach
    void setUp() {
        model = new DefaultTableModel(ColumnIndex.ALL_COLUMNS, 0);
