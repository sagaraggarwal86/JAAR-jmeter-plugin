...
public final class CsvExporter {
     ...
     */
    public CsvExporter(JComponent parent,
    ...
    public void saveTableToCSV(File file) throws IOException {
    ...
    private boolean isTotalRow(int row) {
        Object nameCell = tableModel.getValueAt(row, ColumnIndex.NAME_COL_INDEX);
